...
int usage_of_mpi_fftw3d( int PrR, int lenx, int leny, int lenz, int work_is_null)
{
...
/*--- Usage of MPI FFTW for Complex Multi-dimensional Transforms (work==NULL). fftw3d_create_plan ---*/
    failure += usage_of_mpi_fftw3d(PrR, lenx, leny, lenz, 1);

/*--- Usage of MPI FFTW for Complex Multi-dimensional Transforms. fftw3d_create_plan ---*/
    failure += usage_of_mpi_fftw3d(PrR, lenx, leny, lenz, 0);
